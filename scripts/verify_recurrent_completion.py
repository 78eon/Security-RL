#!/usr/bin/env python3
"""Verify canonical Phase 8 recurrent-study evidence."""
...
def main() -> int:
    ...
    try:
        report = verify_recurrent_completion(repo_root, include_postgres=args.postgres)
    except RecurrentCompletionError as exc:
